...
export default class my {
  ...
  //   eventName = COLOR.firstUpper(eventName)
  ...
  //         break
  //       case 'setFillStyle':
  //         canvasContext.setFillStyle(COLOR.color.array2str(data[1]))
  //         break
  //       case 'setStrokeStyle':
  //         canvasContext.setStrokeStyle(COLOR.color.array2str(data[1]))
  //         break
  //       case 'setFontSize':
  ...
  //       case 'setShadow':
  //         var dat = data[3]
  //         canvasContext.setShadow(data[0], data[1], data[2], COLOR.color.array2str(data[3]))
  //         break
  //       case 'setStrokeStyle':
  //         canvasContext.setStrokeStyle(COLOR.color.array2str(data))
  //         break
  //       case 'drawImage':
  ...
  //   }
  //   object2.success = function (res) {
  //     const result = {networkType: my._network(res).networkType}
  //     if (object.success) {
  //       object.success(result)
  //     }
  //     if (object.complete) {
  ...
  //   }
  //   object2.success = function (res) {
  //     const result = {brightness: res.value}
  //     if (object.success) {
  //       object.success(result)
  //     }
  //     if (object.complete) {
  ...
  //   }
  //   object2.success = function (res) {
  //     const res2 = {value: res.brightness}
  //     if (object.success) {
  //       object.success(res2)
  //     }
  //     if (object.complete) {
  ...
  //     success(res) {
  //       const result = {savedFilePath: res.savedFilePath}
  //       if (object.success) {
  //         object.success(result)
  //       }
  //       if (object.complete) {
  ...
  //     success: (res) => {
  //       const apFilePath = ''
  //       for (const urls of res.tempFilePath) {
  //         apFilePath.url
  //       }
  //       const result = {
  //         apFilePath,
  ...
  //   return getApp().COLORwx._jscode && getApp().COLORwx._login && now <= getApp().COLORwx._login + 1000 * 60 * 60
  // }
  ...
  //   }
  //   object2.success = function (res) {
  //     getApp().COLORwx._login = new Date().getTime()
  //     getApp().COLORwx._jscode = res.code
  //     const result = {authCode: res.code}
  ...
  //   }
  //   if (my._checkSession()) {
  //     object2.success({code: getApp().COLORwx._jscode})
  //   } else {
  //     tt.login(object2)
  //   }
  // };
  ...
  //     success(res) {
  //       console.log(res)
  //       const url = getApp().COLORwx.server + 'userinfo'
  //       const code = getApp().COLORwx._jscode
  //       tt.request({
  //         url, // 目标服务器url
  //         header: {
  ...
  //     getApp().COLORtt.opendata = opendata
  //     for (let cb = 0; cb < getApp().COLORtt.opendataCallbacks.length; cb++) {
  //       getApp().COLORtt.opendataCallbacks[cb](opendata)
  //     }
  //     getApp().COLORtt.opendataCallbacks = []
  //     if (object.success) {
  ...
  //     }
  //   }
  //   const opendata = getApp().COLORtt.opendata
  //   if (opendata) {
  //     if (Object.keys(opendata) > 0) {
  //       object.success(opendata)
  //     } else if (object.success) {
  //       getApp().COLORtt.opendataCallbacks.push(object.success)
  //     }
  //     return
  //   }
  //   getApp().COLORtt.opendata = {}
  //   tt.login({
  //     success(res) {
  //       const jscode = res.code
  //       tt.getAuthUserInfo({
  //         success(res) {
  //           const url = getApp().COLORtt.server + 'opendata'
  //           tt.httpRequest({
  //             url,
  //             header: {
  //               'Content-Type': 'application/x-www-form-urlencoded'
  ...
  //   getApp().COLORwx.getphonenumber = (data, callback) => {
  //     console.log(data)
  //     const code = getApp().COLORwx._jscode
  //     const url = getApp().COLORwx.server + 'phonenumber'
  //     wx.request({
  //       url,
  //       header: {
  //         'Content-Type': 'application/x-www-form-urlencoded'
  ...
  //   }
  //   tt.navigateTo({
  //     url: '/COLORwx/page/getphonenumber/getphonenumber'
  //   })
  // }
  ...
  //   const trade_no = object.tradeNO
  //   const url = getApp().COLORwx.server + 'orderinfo'
  //   tt.request({
  //     url,
  //     header: {
  //       'Content-Type': 'application/x-www-form-urlencoded'
  ...
  //   const url = getApp().COLORtt.server + 'addcard'
  //   tt.httpRequest({
  //     url,
  //     header: {
  //       'Content-Type': 'application/x-www-form-urlencoded'
  ...
  //   const js_code = getApp().COLORtt.jscode
  //   tt.httpRequest({
  //     url: 'http://192.168.0.106:8080/COLOR_adapter/reportMonitor',
  //     header: {
  //       'Content-Type': 'application/x-www-form-urlencoded'
  //     },
  //     method: 'POST',
